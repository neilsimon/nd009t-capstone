...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_data_dir", type=str, default=get_env_if_present("SM_OUTPUT_DATA_DIR")
    )
    parser.add_argument("--model_dir", type=str, default=get_env_if_present("SM_MODEL_DIR"))
    parser.add_argument("--num_gpus", type=str, default=get_env_if_present("SM_NUM_GPUS"))
